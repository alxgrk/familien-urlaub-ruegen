          ...
          <div className="w-full max-w-[80rem] mx-auto flex flex-col items-stretch justify-start">
            { !formSubmittedSuccessfully
                ...
                : <div className="py-[5rem]">
                  ...
                  <p className="text-[1.13rem]">Vielen Dank für Ihre Anfrage! Wir melden uns schnellstmöglichst bei Ihnen.</p>
                  <p className="text-[1.13rem]"><Link href="/">Zurück zur Startseite</Link></p>
                </div>
            }
            <Footer/>
          </div>
