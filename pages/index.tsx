...
import SmallRoom from "../components/small-room";
...
const Homepage: NextPage = () => {
  ...
  return (
    <div className="relative rounded-2xl bg-light-text-color w-full overflow-hidden flex flex-col items-center justify-start text-left text-[3.5rem] text-black font-title-2 lg:w-[75rem] md:w-auto md:[align-self:unset] sm:w-auto sm:[align-self:unset]">
      <MainPageHeader />
      <div className="self-stretch [background:linear-gradient(180deg,_#fff5eb,_#fff_48.44%,_#fff5eb)] flex flex-row items-center justify-start lg:flex lg:pl-[0rem] lg:box-border sm:w-auto sm:[align-self:unset]">
        <Left />
          ...
          <div className="self-stretch flex flex-col items-center justify-start lg:pl-[0rem] lg:box-border md:items-center md:justify-center sm:gap-[0rem] sm:items-start sm:justify-between">
            ...
            <div className="self-stretch h-[88.25rem] flex flex-col py-[9rem] px-[0rem] box-border items-center justify-start gap-[3rem] md:flex-1 md:items-center md:justify-between md:gap-[0rem] sm:flex-1 sm:items-center sm:justify-between sm:gap-[0rem] sm:pl-[0rem] sm:pr-[0rem] sm:box-border">
              ...
              <div className="self-stretch flex-1 flex flex-row py-[3rem] px-[15rem] items-center justify-start gap-[1.25rem] text-[1.38rem] text-light-text-color font-link lg:flex-row lg:gap-[7.5rem] lg:items-start lg:justify-between md:flex-row md:gap-[1.25rem] md:items-start md:justify-start sm:h-auto sm:flex-col sm:gap-[1.25rem] sm:items-start sm:justify-between sm:pl-[15.63rem] sm:pt-[3rem] sm:pr-[15.63rem] sm:box-border">
                <div className="self-stretch flex-1 rounded-3xs overflow-hidden flex flex-col items-center justify-start text-[0.88rem] text-dimgray-200 sm:flex-[unset] sm:self-stretch">
                  <FlexRow
                    icnCircleCircleMd="/icncircle-circlemd.svg"
                    h5="Lage"
                  />
                  <div className="self-stretch flex-1 rounded-2xs bg-light-text-color overflow-hidden flex flex-col py-[1.88rem] px-[3.13rem] items-start justify-start gap-[0.31rem] border-[1px] border-solid border-lightskyblue">
            ...
            <div className="self-stretch flex flex-col py-[10rem] px-[0rem] items-center justify-start gap-[4rem] sm:items-center sm:justify-between sm:gap-[0rem] sm:py-[4rem] sm:px-[0rem] sm:box-border">
              ...
              <div className="self-stretch flex flex-row items-center justify-center relative gap-[1.5rem] md:flex-col md:gap-[1.5rem] md:items-center md:justify-center sm:flex-col sm:items-center sm:justify-between sm:gap-[0rem] sm:pl-[15.63rem] sm:pr-[15.63rem] sm:box-border">
                ...
                >
                  <SmallRoom
                    image="/image1@2x.png"
                    mittlereHtte="Kleine Hütte"
                    betten="3 Betten"
                    prop="25€"
                  />
                  <SmallRoom
                    image="/image2@2x.png"
                    mittlereHtte="Große Hütte"
                    betten="Bis zu 6 Betten"
                    prop="45€"
                  />
                </div>
              </div>
